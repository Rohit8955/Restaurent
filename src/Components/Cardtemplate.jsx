  ...
  return (
    <div>
      <div className='h-[290px] w-[260px]  rounded-[7px] boxshadow flex flex-col gap-[9px] items-start px-[9px] py-[5px] '>
        ...
        <img className='w-full h-[140px] object-cover ' src={props.img} alt="" onClick={()=>imgclicked(props.name)} />
        <div className='flex justify-between w-full items-center '>
          {
            presentincartarr!=-1?(<ItemFreq ind={presentincartarr} freq={cartarr[presentincartarr].quantity}  />):(<button className='bg-green-700 outline-none border-none text-white text-[18px] font-semibold px-[6px] py-[1px] rounded-[5px] hover:bg-green-800' onClick={()=>handleclick(props.name)}>Add To Cart</button>)
          }
